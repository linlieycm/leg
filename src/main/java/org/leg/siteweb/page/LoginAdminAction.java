...
public class LoginAdminAction extends ActionSupport {
	 ...
	 * 日志对象
	 */
	protected static Logger logger = Logger.getLogger(LoginAdminAction.class);
...
//            //根据督导ID查询门店，获得城市ID
//            Record record1 = Storage.executor().load(storeinfoDao.getStoreInfoBySteerId(userId));
//
//            if(null != record1) {
//                ServletActionContext.getContext().put("cityId", record1.getInteger("CityId"));
//            }
