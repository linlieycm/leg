...
<script>
    function exlDown() {
        ...
        window.location.href="/admin/staffSalesMGiftDown?beginDate=" + beginDate + "&endDate=" + endDate +"&cityId=" + cityId;
    }
    function exlQuery() {
        var beginDate = document.getElementById('beginDate').value;
        if(!beginDate) {
        ...
        window.location.href="/admin/staffSalesMGiftDownQuery?beginDate=" + beginDate + "&endDate=" + endDate +"&cityId=" + cityId;
    }
</script>
<body >
<#--<div class="pc-init border relative text-center" >-->
  ...
  <#--<ul class="nav-left ">-->
    ...
    <#--<li class="active"><a href="/admin/staffSalesMGiftDownPre">赠品查询</a></li>-->
