...
<script>
    function exlDown() {
        ...
        window.location.href="/staffSalesMSaleDownSub?beginDate=" + beginDate + "&endDate=" + endDate;
    }
    function exlQuery() {
        var beginDate = document.getElementById('beginDate').value;
        if(!beginDate) {
...
//            return;
//        }
        window.location.href="/staffSalesMSaleDownQuerySub?beginDate=" + beginDate + "&endDate=" + endDate;
    }
</script>
<body >
